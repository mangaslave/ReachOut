...
import EmployersMatches from "../../../public/static/images/employers-matches.png"; 
      ...
      <div className="flex w-full h-max bg-spaceCadet">
        <div className="flex flex-col ml-20 xl:ml-52 justify-evenly w-1/2 max-w-lg z-20 relative">
          ...
          <p className="md:py-4 text-sm text-white md:text-lg">
            Discover how second-chance hiring can benefit your business. From accessing tax credits to improving retention rates, ReachOut makes it easy to connect with motivated candidates who are ready to make an impact.
          </p>
        ...
        <div className="relative z-10 w-1/2 mr-0 ml-auto">
          ...
          <Image src={EmployersHeroImage} alt="Hero image" width={1000} height={1000} className="object-cover w-full h-full pr-40" />
        </div>
      </div>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-8">
                <li>
                  <span className="font-semibold">Candidate Recommendations: </span> View a list of potential hires 
          ...
          <div className="flex">
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-3">
                <li>
                  <span className="font-semibold">Streamlined Organization: </span> Keep track of all the candidates that have applied to your posting and drag and drop them into the appropriate categories (i.e. “Under Review”, “Interview”, etc.).
                </li>
                <li>
                  <span className="font-semibold">Applicant Profiles: </span> View all candidate details at a glance, including resumes, skills, and work history, directly on their application cards.
                </li>
              </ul>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-14">
                <li>
                  <span className="font-semibold">Second-Chance Hiring Guides:</span> Access comprehensive guides on implementing second-chance hiring practices.
                </li>
                <li>
                  <span className="font-semibold">Legal Compliance Support:</span> Stay informed about local and federal hiring laws.
                </li>
                <li>
                  <span className="font-semibold">Tax Incentive Information:</span> Learn how to access wage subsidies, the Federal Bonding Program, and provincial hiring incentives for marginalized groups.
                </li>
              </ul>
        ...
        */}
        <div className="flex flex-col items-center justify-center w-full bg-spaceCadet">
          ...
          <p className="text-white pt-1 pb-8">Can't find what you're looking for? Contact us <Link href="/" className="underline hover:text-spaceCadet">here</Link>.</p>
        </div>
          ...
          <ul>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                Second-chance hiring allows you to access a motivated talent pool, reduce turnover rates, and contribute to your community’s growth. Studies show that second-chance employees often outperform their peers in terms of loyalty and productivity.
              </p>
            </li>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                Yes, you will receive notifications when candidates apply, respond to interview requests, or update their profiles.
              </p>
            </li>
            <li>
              <h4 className="font-bold text-lg/5 mt-5">
              ...
              <p className="text-base leading-5 mt-4 mb-14">
                Absolutely. We use advanced security measures to ensure your data and candidate information remain private and protected.
              </p>
            </li>
          </ul>
        </div>
