      ...
      <div className="flex w-full h-max bg-ylnMnBlue">
        <div className="flex flex-col ml-20 xl:ml-52 justify-evenly w-1/2 max-w-lg z-20 relative">
          ...
          <p className="md:py-4 text-sm text-white md:text-lg">
            Your skills, experiences, and determination define your potential—not your past. That's why
            we connect you with employeers who see your value and are committed to giving you the opportunity
            to succeed. Whether you're looking to start fresh, build a career, or explore new possibilites,
        ...
        <div className="relative z-10 w-1/2 mr-0 ml-auto">
          ...
          <Image src={JobSeekersHeroImage} alt="Hero image" width={1000} height={1000} className="object-cover w-full h-full pr-40" />
        </div>
      </div>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-8">
                ...
                <li>
                  <span className="font-semibold">Compatibility:</span> View which jobs are most suited for you
                  based on your skill set, preferences, and criminal background.
                </li>
                <li>
                  <span className="font-semibold">Automated Applications:</span> Simply choose which job you want
                  to apply for and we'll do all the tedious work for you.
                </li>
              </ul>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-14">
                <li>
                  <span className="font-semibold">AI-Automation:</span> Answer a few questions about yourself
                  and our AI model will generate an industry-ready resume in minutes.
                </li>
                <li>
          ...
          <ul>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                No, ReachOut is completely free to all users. Our full library of resources, tools, and support features can be accessed at no cost.
              </p>
            </li>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                We offer resume and cover letter templates, interview tips, and guides on building workplace skills. You can also access training programs and certifications to enhance your employability.
              </p>
            </li>
            <li>
              <h4 className="font-bold text-lg/5 mt-5">
              ...
              <p className="text-base leading-5 mt-4 mb-14">
                Our support team is here to help! You can contact us through the help center or email us directly with any questions or concerns.
              </p>
            </li>
          </ul>
        </div>
