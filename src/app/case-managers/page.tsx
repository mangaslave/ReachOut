      ...
      <div className="flex w-full h-max bg-caribbeanCurrant">
        <div className="flex flex-col ml-20 xl:ml-52 justify-evenly w-1/2 max-w-lg z-20 relative">
          ...
          <p className="md:py-4 text-sm text-white md:text-lg">
            ReachOut believes nonprofit organizations are the first step to helping previously incarcerated individuals begin their new lives. That's why we've built a platform that allows you to empower these individuals by providing them with all the tools and resources you'll need.
          </p>
        ...
        <div className="relative z-10 w-1/2 mr-0 ml-auto">
          ...
          <Image src={CaseManagerHeroImage} alt="Hero image" width={1000} height={1000} className="object-cover w-full h-full pr-40" />
        </div>
      </div>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-8">
                ...
                <li>
                  <span className="font-semibold">Automated Applications:</span> Simply choose which client you're applying
                  for and we'll do all the hefty work.
                </li>
              </ul>
        ...
        */}
        ...
        <div className="flex flex-col items-center justify-between pb-16 pt-6 w-full h-max bg-ylnMnBlue bg-opacity-10">
          <div className="flex">
            <div className="flex flex-col justify-evenly items-center mx-10">
              <h1 className="text-darkCarribbeanCurrant text-lg md:text-4xl font-bold p-6">Centralized Client Management</h1>
        ...
        <div className="flex flex-col items-center justify-between py-20 w-full h-max bg-ylnMnBlue bg-opacity-10">
          <div className="flex">
            ...
            <div className="flex flex-col justify-evenly items-center mx-10">
              ...
              <ul className="max-w-md px-8 list-disc my-14">
                <li>
                  <span className="font-semibold">AI-Automation:</span> Answer a few questions about your client
                  and our AI model will generate a industry-ready resume in minutes.
                </li>
                <li>
                  <span className="font-semibold">AI Recommendations:</span> Already have a resume? Upload it and 
                  our AI will provide suggestions for improvement to boost its effectiveness.
                </li>
              </ul>
              <button className="font-bold mr-60 text-white rounded-lg mb-6 w-44 h-12 pt-3 pb-3 bg-caribbeanCurrant hover:bg-darkCarribbeanCurrant">
                Try Now
        ...
        */}
        <div className="flex flex-col items-center justify-center w-full bg-caribbeanCurrant">
          ...
          <p className="text-white pt-1 pb-8">Can't find what you're looking for? Contact us <Link href="/" className="underline hover:text-darkCarribbeanCurrant">here</Link>.</p>
        </div>
          ...
          <ul>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                Yes! ReachOut is designed to help individuals with any amount of experience. We provide a database
                of educational materials and skill-building workshops to prepare your clients for the workforce. ReachOut's 
                job dashboard also allows you to curate a list of specifically entry-level jobs.
              </p>
            </li>
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-10">
                Yes! Clients are able to make their own accounts at ReachOut where they can apply to job 
                listings themselves. If you'd like, you can link your accounts so that you can review their 
            ...
            <li>
              ...
              <p className="text-base leading-5 mt-4 mb-14">
                Yes! ReachOut is passionate about inclusivity and ensuring that our services accommodate people 
                with all sorts of needs. We believe in transparency and encourage employers to indicate whether
                their workspace is suitable for people of various needs, including wheelchair accessibility, remote
                options, and onboarding support.
              </p>
            </li>
          </ul>
        </div>
