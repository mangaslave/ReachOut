...
import { FilterState } from "@/components/client/JobListingFilters";
				...
				<main className="flex-1 overflow-y-auto lg:px-8 mt-4">
					...
					<div className="max-w-7xl mx-auto">
						<div className="flex justify-between items-center mb-4">
							<div className="flex">
								<JobListingFilters onFilterChange={handleFilterChange} />
							</div>
							...
							<div className="mt-4 p-2 flex flex-col gap-2">
								...
								<div className="flex gap-4 text-lg">
									...
									{activeFilters.jobType && (
										<span>
											Job Type:{" "}
											<span className="font-bold">{activeFilters.jobType}</span>{" "}
										</span>
									)}
									{activeFilters.client && (
										<span>
											Client:{" "}
											<span className="font-bold">{activeFilters.client}</span>
										</span>
									)}
								</div>
							</div>
