...
export function ApplicationModal ({ isOpen, setOpen}: ModalProps)  {
  return (
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="p-4 space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600">John Wick</p>
          </div>
          ...
          <div className="flex gap-2 pt-4">
            ...
            <Button variant="outline" className="flex-1 bg-red-500">Discard</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
