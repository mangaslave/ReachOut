            ...
            <main className="flex">
              <section className="flex-col justify-center items-center">
                ...
                <div className="flex justify-evenly border-2 border-caribbeanCurrant bg-gray-200 rounded-xl mt-3 p-1 w-80">
                  <button className="bg-caribbeanCurrant text-white w-16 text-center rounded-lg font-medium">
                    All
                  </button>
                  <button className="hover:bg-caribbeanCurrant hover:text-white w-16 text-center rounded-lg hover:font-medium">
                    Read
                  </button>
                  <button className="hover:bg-caribbeanCurrant hover:text-white w-16 text-center rounded-lg hover:font-medium">
                    Unread
                ...
                <InboxPreview
                  ...
                  subject="Match Found!"
                  time="12:21PM"
                  content="Hey Giselle! ReachOut has found a match for Leon Howard for..."
                />
                <div className="w-10/12 h-px bg-caribbeanCurrant my-7"></div>
                <InboxPreview
                  sender="Samuel Robinson"
                  subject="Application Status"
                  time="10:02AM"
                  content="Hey! Your client Gregory Wick's resume is currently..."
                />
                <div className="w-10/12 h-px bg-caribbeanCurrant my-7"></div>
                <InboxPreview
                  sender="Sarah Duvale"
                  ...
                  time="Yesterday"
                  content="So I've seen a couple of companies that I think want to get into..."
                />
              </section>
