...
const Reminders = () => {
  return (
    <div className="p-5 w-full max-w-md">
      ...
      <ReminderItem title="Meeting w/ Andrew Norman" date="Nov 12" time="10:30am" statusColor="bg-red-500" />
      <ReminderItem title="Meeting w/ Jack Brown" date="Nov 14" time="12:30pm" statusColor="bg-red-500" />
